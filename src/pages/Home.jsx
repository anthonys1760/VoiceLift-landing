...
const CSS = [
  ...
  ".phone-frame { position: relative; width: min(360px, 72vw); margin: 0 auto; background: #1a1a1a; border-radius: 50px; padding: 10px; box-shadow: 0 0 0 2px #333, 0 0 0 5px #111, 0 50px 100px rgba(0,0,0,0.7), 0 0 60px rgba(232,255,71,0.06); }",
  ...
  ".showcase-grid { display: flex; justify-content: center; gap: 40px; flex-wrap: nowrap; align-items: flex-start; }",
  ...
  ".showcase-item { flex: 1; min-width: 0; }",
  ".showcase-item .phone-frame { width: 100%; max-width: 320px; margin: 0 auto; }",
  "@media (max-width: 640px) { .showcase-grid { flex-wrap: wrap; gap: 48px; } .showcase-item { flex: unset; } .showcase-item .phone-frame { width: min(280px, 78vw); max-width: none; } }",
