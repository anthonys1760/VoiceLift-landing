...
const CSS = [
  ...
  ".phone-frame { position: relative; width: min(320px, 72vw); margin: 0 auto; background: #1a1a1a; border-radius: 50px; padding: 10px; box-shadow: 0 0 0 2px #333, 0 0 0 5px #111, 0 50px 100px rgba(0,0,0,0.7), 0 0 60px rgba(232,255,71,0.06); }",
  ...
  ".showcase-item .phone-frame { width: 100%; max-width: 260px; margin: 0 auto; }",
